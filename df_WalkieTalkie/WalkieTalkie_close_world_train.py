...
print(make_model(100)(x).shape)

# %%
def LoadDataWalkieTalkieCW():

    print ("Loading WalkieTalkie dataset for closed-world scenario")
    # Point to the directory storing data
    dataset_dir = '/data/Deep_fingerprint/walkie_talkie/close_world/'
...
def train(net, train_iter, valid_iter, num_epochs, lr, device, betas, eps, weight_decay):
    ...
    for epoch in range(num_epochs):
        ...
        if valid_l < best_loss:
            best_loss = valid_l
            torch.save(net.state_dict(), '/home/xjj/projects/graduate_project/df_WalkieTalkie/WalkieTalkie_cw_model') # Save your best model
...
net = make_model(100)
state_dict = torch.load('/home/xjj/projects/graduate_project/df_WalkieTalkie/WalkieTalkie_cw_model')
