...
def process_dataset(file_name, suffix, train):
    ...
    for i,line in enumerate(lines):
        ...
        if train == True:
            if i < 85500:
                ...
                para_list.append((traces_path_ow + l))
        else:
            if i < 9500:
                para_list.append((traces_path + l))
            else:
...
if __name__ == '__main__':
    ...
    defence = 'wtf_pad_ow'
    traces_path = '/data/Deep_fingerprint/RF_data/WTF_PAD/'            # TODO: change to your dataset path
    traces_path_ow = '/data/Deep_fingerprint/RF_data/WTF_PAD_ow/'
#Undefended  Undefended_OW  WTF_PAD  WTF_PAD_OW  W_T_Real

    # feature_func = 'packets_per_slot'

    train_name = '/home/xjj/projects/graduate_project/RF_wtf_pad/list/open-Index_train.txt'
    test_name = '/home/xjj/projects/graduate_project/RF_wtf_pad/list/open-Index_test.txt'

    process_dataset(train_name, 'train', train = True)
    process_dataset(test_name, 'test', train = False)