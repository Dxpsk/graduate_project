...
def LoadDataWTFPADCW():
    ...
    print ("Loading WTFPAD dataset for open-world scenario")
...
# %%
X_train, y_train, X_valid, y_valid = LoadDataWTFPADCW()
...
def train(net, train_iter, valid_iter, num_epochs, lr, device, betas, eps, weight_decay):
    ...
    for epoch in range(num_epochs):
        ...
        if valid_l < best_loss:
            best_loss = valid_l
            torch.save(net.state_dict(), '/home/xjj/projects/graduate_project/df_wtf_pad/wtf_pad_ow_model') # Save your best model
...
wandb.init(project='DF_wtf_pad_OW',
           name='2st_run',
