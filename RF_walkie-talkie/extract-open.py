...
if __name__ == '__main__':
    ...
    defence = 'walkie-talkie_ow'
    traces_path = '/data/Deep_fingerprint/RF_data/W_T_Real/'            # TODO: change to your dataset path
#Undefended  Undefended_OW  WTF_PAD  WTF_PAD_OW  W_T_Real

    # feature_func = 'packets_per_slot'

    train_name = '/home/xjj/projects/graduate_project/RF_walkie-talkie/list/open-wt_train.txt'
    test_name = '/home/xjj/projects/graduate_project/RF_walkie-talkie/list/open-wt_test.txt'
