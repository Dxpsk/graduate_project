...
LR = 0.0005
if_use_gpu = 1
num_classes = const.num_classes_ow
...
def train(net, train_iter, num_epochs, lr, device):
    ...
    torch.save(net.state_dict(), '/home/xjj/projects/graduate_project/RF_walkie-talkie/model_ow') # Save your best model
...
if __name__ == '__main__':
    ...
    wandb.init(project='walkie-talkie_ow',
               name='1st_run',
               config={'learning_rate': LR,
                       'batch_size': BATCH_SIZE,
                       'epoch': EPOCH+10,
                       'num_classes': num_classes})
    defense = 'walkie-talkie_ow'
