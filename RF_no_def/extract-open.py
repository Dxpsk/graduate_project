...
if __name__ == '__main__':
    ...
    defence = 'Undefence_ow'
    traces_path = '/data/Deep_fingerprint/RF_data/Undefended/'            # TODO: change to your dataset path
    traces_path_ow = '/data/Deep_fingerprint/RF_data/Undefended_ow/'
#Undefended  Undefended_OW  WTF_PAD  WTF_PAD_OW  W_T_Real

    # feature_func = 'packets_per_slot'

    train_name = '/home/xjj/projects/graduate_project/RF_no_def/list/open-Index_train.txt'
    test_name = '/home/xjj/projects/graduate_project/RF_no_def/list/open-Index_test.txt'
