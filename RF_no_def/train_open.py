...
def train(net, train_iter, num_epochs, lr, device):
    ...
    torch.save(net.state_dict(), '/home/xjj/projects/graduate_project/RF_no_def/model_ow') # Save your best model
...
if __name__ == '__main__':
    ...
    wandb.init(project='RF_no_def_ow',
               name='1st_run',
               config={'learning_rate': LR,
                       'batch_size': BATCH_SIZE,
                       'epoch': EPOCH,
                       'num_classes': num_classes})
    defense = 'Undefence_ow'
